...
// Direct audio streaming to the 44.1 kHz FLX4 USB Audio DAC. The source is the
// shared 44.1/48 kHz output clock and is converted before the four-channel ring
// (Ch1/2 Master, Ch3/4 Headphones).
