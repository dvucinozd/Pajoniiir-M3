...
| R2 | FLX4 UAC1 descriptor/alternate-setting ili ring tlak odstupa od pretpostavke | nema slušalica, krivi format ili drop | descriptor testovi, hardware enumeration smoke, fail-closed endpoint izbor te active-playback 1/4–3/4 ring alarm bez idle-underflow lažnih incidenata |
