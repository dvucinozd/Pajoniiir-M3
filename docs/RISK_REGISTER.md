...
| R3 | Audio output task probije blok deadline | čujni klik/underrun | single-precision DSP, bounded I/O, zabrana packet-level logiranja u FLX4 real-time callbacku, phase timing telemetry i soak; headphone-level burst gate prošao bez latea |
...
Najveći otvoreni acceptance rizici su disconnect/EOF deadline rubovi te izravni
FLX4 MIDI/UAC put uz istodobni USB3, više Wi-Fi klijenata i aktivan UI.
