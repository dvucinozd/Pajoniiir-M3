...
| R3 | Audio output task probije blok deadline | čujni klik/underrun | single-precision DSP, bounded I/O, zabrana packet-level logiranja u FLX4 real-time callbacku, rano spuštanje prioriteta na canceled/no-device transferu, phase timing telemetry i soak; headphone-level i USB2 disconnect gateovi prošli bez latea |
...
Najveći otvoreni acceptance rizici su izravni FLX4 MIDI/UAC put uz istodobni
USB3, više fizičkih Wi-Fi klijenata i aktivan UI te bring-up još nedostupnog
800×480 DSI/FT5426 sklopa.
