...
| R5 | MIDI mapping ili shift state nije potpun | pogrešna kontrola ili LED | autoritativni Mixxx XML, službeni MIDI popis i map acceptance ledger; shifted Beat Jump, Loop Adjust `0x4C/0x4E`, D1/D2 Quantize, Censor, Sync Master, Reloop Stop/Forget i shifted Beat FX hardverski potvrđeni 2026-08-24; preostaju globalni shifted helperi |
